...
While analyzing the vulnerability, I discovered that the **Windows 11 Insider (26H2)** build is not susceptible to this crash. By comparing the assembly of `MiCallCreateSectionFilters` across both versions, we can see exactly how Microsoft refactored the synchronization logic.
