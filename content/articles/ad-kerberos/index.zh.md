...
## Windows
以下代码演示了如何在 Windows 环境中生成 Kerberos TGT 和 ST，以及它们如何被 [bloodyAD](https://github.com/CravateRouge/bloodyAD) 使用。当然，在大多数情况下，您已经有了可用的票据。在这种情况下，直接跳到 [bloodyAD](https://github.com/CravateRouge/bloodyAD) 部分。
